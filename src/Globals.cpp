...
namespace G
{
    ...
    void Init()
    {
        ...
        iniPrefSettings = RVA<INIPrefSettingCollection*>(GET_RVA(g_iniPrefSettings),
            "48 8B 1D ? ? ? ? E8 ? ? ? ? 4C 8D 43 08 48 8B 1D ? ? ? ? 4D 85 C0 74 16 48 8D 4B 08 4C 3B C1 74 11 BA 04 01 00 00 FF 15 ? ? ? ? EB 04 44 88 73 08", 0, 3, 7); //vr
    }
